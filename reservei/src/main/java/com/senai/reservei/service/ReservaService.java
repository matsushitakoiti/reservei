...
public class ReservaService {
    ...
    public ResponseEntity criarReserva(ReservaCreateDTO reservaDTO) {
        ...
        boolean reservaExistente = reservaRepository.existsByDataEntradaLessThanEqualAndDataSaidaGreaterThanEqualAndStatusAndQuartoId(reservaDTO.getDataSaida(), reservaDTO.getDataEntrada(), StatusReservaEnum.ATIVA, reservaDTO.getQuarto());
    ...
    public boolean verificarReservasPorDatas(Date dataEntrada, Date dataSaida, Long quartoId) {
        return reservaRepository.existsByDataEntradaLessThanEqualAndDataSaidaGreaterThanEqualAndQuartoId(dataEntrada, dataSaida, quartoId);
    }
